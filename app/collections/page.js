...
const page = () => {
  return (
    <section className='w-full flex justify-center items-center text-center pt-32'> 
        <div className='align-center flex-col'>
            <h2 className='text-2xl font-semibold mb-10 tracking-wider'>New and old bits.. </h2>
            <div className='my-16'>
                <Image
                    src='/collection1.png'
                    width={335}
            ...
            <div className='flex w-full mt-24 mb-4 justify-center'>
                <Link href="/events" className='font-rubik bg-gray-300 text-center uppercase font-bold p-3 w-5/6 border-none text-sm'>
                    Explore Events
                </Link>
            </div>
        </div>
