    ...
    <section className='w-full flex-col justify-center text-center pt-32'> 
        ...
        <div className='w-full px-8'>
            ...
            <div className='my-16 md:flex justify-center items-center w-full'>
                ...
                <div className='md:w-1/2'>
                    <h2 className='overline text-2xl font-bold my-5 md:w-40 m-auto leading-none'>Family Portrait</h2>

                    <p className='font-rubik text-left text-lg bg-white w-64 md:w-52 p-3 m-auto mb-8'>This collection is centered around my move to the UK with my family as a child, being close with my family and holding on to my memories of my time in Nigeria. This collection honors my lineage and family for being there along the way, guiding and strengthening me through each of my decisions.</p>
            ...
            <div className='my-16 md:flex justify-center items-center w-full'>
                ...
                <div className='w-full md:w-1/2'>
                    ...
                    <p className='font-rubik text-left text-lg bg-white w-64 md:w-52 p-3 m-auto mb-8'>“The honest truth about having a creative process and discovering the ‘final final’ art piece is learning to channel maximum energy during a low period instead of just dwelling on the emotions coursing within…”</p>
