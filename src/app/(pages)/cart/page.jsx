...
const Cart = () => {
    ...
    const EmptyCart = () => (
        <div className="flex flex-col justify-center items-center">
            ...
            <h4 className="text-center font-thin font-rubik">Your cart is empty
                <Link href="/collections" passHref className="text-orange-700">
                    , pick some items!
                </Link>
            </h4>
        </div>
  ...
  return (
    <>
        <div className='min-h-screen bg-white flex-col justify-centre items-center align-center pt-16'>
            ...
            <div className='mt-20'>
                 { !cart.art.length ? <EmptyCart /> : <FilledCart /> }
            </div>
        </div>
    </>
  );
