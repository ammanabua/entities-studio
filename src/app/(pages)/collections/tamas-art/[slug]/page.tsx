        ...
        <div className="w-full lg:flex justify-center gap-16">
          <div className="w-full lg:w-3/5">
            <Link href={`/images/${params.slug}`}>
              <Image src="/tamas-art/fascination-dg.png" width={0} height={0} alt="tamas art" className="mb-8 w-full h-auto m-auto" sizes="100vw" />
            </Link>

            <Image src="/tamas-art/fascination-live.jpg" width={0} height={0} alt="tamas art fascination live" className="w-full h-auto m-auto" sizes="100vw" />
          </div>
