...
export default async function Page() {
  ...
  return (
    <section className="w-full align-center text-center pt-28 mb-4">
      <h2 className="text-4xl font-bold uppercase mb-20">Family Portrait</h2>
      ...
      <div className="flex justify-center w-full">
        <Image src="/family-portrait.png" width={250} height={250} alt="Family Portrait" sizes="100vw" style={{ width: '100%', height: 'auto' }} />
      </div>
