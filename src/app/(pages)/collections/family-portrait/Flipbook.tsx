...
export default function Flipbook({ collection }: { collection: any[] }) {
  return (
    <>
      <Swiper effect={'cards'} grabCursor={true} modules={[EffectCards]} className="font-sans w-4/6 lg:w-1/3 h-[90%] align-center justify-center overflow-hidden m-auto drop-shadow-xl">
        <SwiperSlide className="bg-[#E96F1D] align-center h-auto">
          <div className="border-2 border-black m-4 lg:h-[94%] bg-white p-8 space-y-4">
            <Image src="/chimdi.png" width={0} height={0} sizes="100vw" className="w-full border-2 border-black h-auto rounded-full p-4" alt="Chimdi - Entities Studio Artist" />
            ...
            <Image src="/head.png" width={70} height={46} alt="Entities Studio" style={{ maxWidth: '100%', height: 'auto' }} className="m-auto" />
          </div>
        </SwiperSlide>
          ...
          <div className="flex justify-center border-2 border-black m-4 lg:h-[94%] bg-white p-8 items-center tracking-wide">
            <div>
              ...
              <div className="border-2 border-black p-8 bg-gray-200 my-12 space-y-8 leading-7">
                ...
                <p>I honor you all.</p>
                <Image src="/head.png" width={60} height={40} alt="Entities Studio" style={{ maxWidth: '100%', height: 'auto', margin: 'auto' }} />
              </div>
            </div>
          </div>
        </SwiperSlide>
        ...
        <SwiperSlide className="bg-[#E96F1D] h-full">
          <div className="flex border-2 border-black m-4 lg:h-[94%] items-center bg-[#E7E7D0] p-8 space-y-4">
            <div className="space-y-8 text-sm tracking-wide leading-6">
              ...
              <Image src="/head.png" width={60} height={36} alt="Entities Studio" style={{ maxWidth: '100%', height: 'auto', margin: 'auto' }} />
            </div>
          </div>
        </SwiperSlide>
            ...
            <div className="border-2 border-black m-4 lg:h-[94%] bg-white p-8">
              <div>
                <Link href={`/images/${item._id}`}>
                  <Image src={item.url} alt={item.title} width={400} height={0} className="w-full lg:h-72" />
                </Link>
              </div>
              ...
              <div className="flex w-full justify-end mt-4 right-8">
                <Image src="/head.png" width={40} height={26} alt="Entities Studio" className="flex" />
              </div>
            </div>
          </SwiperSlide>
        ))}
            ...
            <div className="border-2 border-black bg-[#E7E5CE] my-4">
              <div className="text-xs tracking-widest pt-4 px-2 space-y-4">
                ...
                <div className="w-100 flex justify-end">
                  <Image src="/head.png" width={50} height={46} alt="Entities Studio" className="" />
                </div>
              </div>
            </div>
