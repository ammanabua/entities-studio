...
export const collections = [
  {
    ...
    desc: "This collection is centered around my move to the UK with my family as a child, being close with my family and holding on to my memories of my time in Nigeria. This collection honors my lineage and family for being there along the way, guiding and strengthening me through each of my decisions.",
    images: [
      {
        name: "Welcome Home",
      ...
      },
      {
        ...
        url: "/family-portrait/blue-soldier.webp"
      },
      {
        name: "Voids",
      ...
      },
      {
        ...
        url: "/family-portrait/first-date.webp"
      },
      {
        name: "Siblings",
      ...
      },
      {
        ...
        url: "/family-portrait/ancestral-lines.webp"
      },
      {
        name: "My Family",
  ...
  {
    title: "Tamas Art",
    desc: "The honest truth about having a creative process and discovering the ‘final final’ art piece is learning to channel maximum energy during a low period instead of just dwelling on the emotions coursing within...",
    images: [
      {
        name: "Get Home Safe",
        intro: "The importance of seeing a friend off and waving goodbye.",
        url: "/tamas-art/get-home-safe.webp",
        category: 'Art'
      },
      {
        name: "Smiles",
        intro: "Experience things that make you smile.",
        url: "/tamas-art/smiles.webp",
        category: 'Art'
      },
      {
        name: "Can I walk With You?",
        intro: "Appreciating other's company.",
        url: "/tamas-art/walk-with-you.webp",
        category: 'Art'
      },
      {
        name: "The World Outside is Within (World Between Places)",
        intro: "Laying on my back in my bed with my eyes shut, I dream of myself on the grass outside experiencing the world around me but before I fully open my eyes there is always a beautiful combination of my physical surrounding (my room) and my dream syncing together as one world... this is my World Between Places.",
        url: "/tamas-art/friends.webp",
        category: 'Art'
      },
      {
        name: "What am I?",
        intro: "",
        url: "/tamas-art/what.webp",
        category: 'Art'
      },
      {
        name: "A Fascination",
        intro: "A Great Big Fish enchanted by a little pistachio shell",
        url: "/tamas-art/fascination.webp",
        category: 'Art'
      },
      {
        name: "Shadow Peoples",
        intro: "Reflections only show part of the truth",
        url: "/tamas-art/shadows.webp",
        category: 'Art'
      },
      {
        name: "The Grey Matters",
        intro: "A world where everything always stays grey",
        url: "/tamas-art/greys.webp",
        category: 'Art'
      },
      {
        name: "The Road Behind My House",
        intro: "The importance of a path is for a traveller to know.",
        url: "/tamas-art/road.webp",
        category: 'Art'
      },
      {
        name: "Directions Please",
        intro: "There is always help to give, all you have to do is ask.",
        url: "/tamas-art/directions.webp",
        category: 'Art'
      },
    ]
  }
